...
export const TextToSpeech = (props) => {
  ...
  const [ttsInput, setTtsInput] = useState({ name: "", text: "" });
  ...
  async function onSubmit(event) {
    ...
    let fileName = voice + "-" + "AI-voice-" + ".mp3";
    ...
    <div>
      ...
      >
        <Box className="modal-ai" sx={style}>
          ...
          <div style={{ marginBottom: "40px", color: "#0008" }}>
            <h3
              style={{ textAlign: "center", fontWeight: "500", color: "#0008" }}
            >
            ...
            <ul>
              <li>
                <h3 style={{ fontWeight: 500, color: "#0008" }}>Dicas</h3>
              </li>
              <li>
                <p>
                  {" "}
                  "Você pode adicionar emoção, pausas e quebras na fala usando"
                  "<b>..</b>" (pausa curta), "<b>--</b>" (pausa média), "
                  <b>-</b>" (pausa longa) e{" "}
                  <span style={{ color: "#0008" }}>
                    <b>&lt;break time="1.5s" /&gt;</b>
                  </span>{" "}
              ...
              <li>
                Para colocar emoções, eu posso usar o texto como em um livro.
                Exemplo: "Você tem certeza disso?" ele disse, confuso. "Não me
                teste!" ele gritou com raiva.
              </li>
              <li>
                <p style={{ color: "#0008" }}>
          ...
          <form disabled onSubmit={onSubmit} autocomplete="off">
            <div style={{ display: "flex", margin: "1rem auto" }}>
              <input
                ...
                value={ttsInput.name}
                onChange={(e) =>
                  setTtsInput({ ...ttsInput, name: e.target.value })
                }
              ...
              <input
                ...
                value={ttsInput.text}
                onChange={(e) =>
                  setTtsInput({ ...ttsInput, text: e.target.value })
                }
